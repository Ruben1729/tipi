...
#define TIPI_OVERHEAD(payload)  ((payload) + ((payload)/254) + 1 + 2 + 2)
...
typedef void (*tipi_cmd_handler_fn)(uint8_t tag, uint8_t* buffer, uint16_t size);
